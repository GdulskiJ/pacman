...
public class Lokomotywa {
    static ArrayList<Lokomotywa> Lokomotywy = new ArrayList<>();

    String name;
    int maxCarts;
    int maxWeight;
    int maxElectricityCarts;
    int id;
    ...
    List<Vertex> pathmiedzystacjami = new ArrayList<>();
    double calkowitydystans;
    double calatrasa;
    double calatrasaprocent;

    double dystansdostacji;

    double dystansdostacjiprocent;
    double dystans;



    public Lokomotywa(String name, int maxCarts, int maxWeight, int maxElectricityCarts, int predkosc,
                      Vertex poczatek, Vertex koniec) {

        this.name = name;
        this.maxCarts = maxCarts;
        this.maxWeight = maxWeight;
        this.maxElectricityCarts = maxElectricityCarts;
        this.id = counter;
